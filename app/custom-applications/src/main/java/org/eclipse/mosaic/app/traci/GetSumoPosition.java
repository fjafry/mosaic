...
/**
 * This application gets the position of the vehicle in SUMO coordinates through
 * the interface traci
 */
public class GetSumoPosition extends AbstractApplication<VehicleOperatingSystem>
    ...
    public void onSumoTraciResponded(SumoTraciResult sumoTraciResult) {
        if (sumoTraciResult.getRequestCommandId().equals(lastSentMsgId)) {
            ...
            getLog().infoSimTime(this, "Position of vehicle {} is x: {}, y: {}", positionResponse.vehicleId,
                    positionResponse.xPos, positionResponse.yPos);
        }
    }
    ...
    private PositionResponse decodeGetPosition(final byte[] msg) {
        ...
        try {
            ...
            int variableType = dis.readUnsignedByte(); // type of response, should be 0x01 for 2Dposition
                                                       // https://sumo.dlr.de/docs/TraCI/Protocol.html#position_representations
