 ...
 */
public class ChangeLane extends AbstractApplication<VehicleOperatingSystem>
    ...
    private byte[] assembleTraciCommand(String vehicleId, SlowDownParams params) {
        ...
        final byte TRACI_SLOW_DOWN = (byte) 0x13; // Bits Traci Variable Identifier (0x14 for slow down)
        ...
        try {
            ...
            dos.writeByte(0x8); // double type
            dos.writeByte(1); // target speed
            dos.writeByte(0xb); // double type
            dos.writeDouble(25); // duration
        } catch (IOException e) {
    ...
    public void processEvent(Event event) throws Exception {
        ...
        if (resource instanceof VehicleConfig) {
            ...
            // getLog().infoSimTime(this, "Vehicle emergency break is requested through
            // traci");
            SlowDownParams params = new SlowDownParams(1, 25);
